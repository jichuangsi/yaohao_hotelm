...
public class PredeterminePo {
	...
	private Integer depoiststatus;//押金状态
...
/*--------------------------------------------  预定旅客ID end ------------------------------------------------------------*/		
	...
	public Integer getDepoiststatus() {
		return depoiststatus;
	}

	public void setDepoiststatus(Integer depoiststatus) {
		this.depoiststatus = depoiststatus;
	}
	...
	private Integer rentOutTypeID;//出租方式
