...
public class PredetermineServiceImpl implements PredetermineService {
	...
	public PredeterminePo selectDetailById(Integer id) {
		return predetermineDao.selectDetailById(id);
	}

	@Override
	public Integer selectOneTime() {
		return predetermineDao.selectOneTime();
	}

	@Override
	public Integer selectPreSupplier(Integer supplierid) {
		return predetermineDao.selectPreSupplier(supplierid);
	}

	@Override
	public Integer selectPrePlatform(Integer platformid) {
		return predetermineDao.selectPrePlatform(platformid);
	}
}
