...
public interface StayRegisterDao {
	...
	//新增住宿明细
	public int insertStayregisterdetails(@Param("stayRegisterID") int stayRegisterID, @Param("passengerID") int passengerID,@Param("codeNumber") String codeNumber, @Param("platformID") int platformID);
...
/*-------------------------------------FinancialStatistics--------------------------------------------------------*/
  ...
  //分页模糊查询 Five
   ...
   //分页模糊查询总条数 Five
	...
	//根据 已结账 来查询 总费用 精简版条件 结账区段
	public List<StayRegisterPo> selectPayJingJianBanf(@Param("min") Timestamp min, @Param("max") Timestamp max);
	...
	//根据 已结账 来查询 旅客总消费。条件 结账区段
	public List<StayRegisterPo> selectPayXiaoFeif(@Param("min") Timestamp min, @Param("max") Timestamp max);
	...
	public Integer updateDepoit(@Param("id") Integer id, @Param("depoist") Integer depoist);
...
//=============================================C==================================================================//
	...
	//根据订单号查询分页
	public List<StayRegisterPo> pageFuzzyselectOrder( @Param("receiveTargeTypeID") int receiveTargeTypeID,
													  @Param("isBillID") int isBillID,@Param("codeNumber") String codeNumber,
											   @Param("start") int start, @Param("pageSize") int pageSize);
	//根据订单号查询总数
	public Integer countFuzzyselectOrder( @Param("receiveTargeTypeID") int receiveTargeTypeID,
										  @Param("isBillID") int isBillID,@Param("codeNumber") String codeNumber);


	//分页模糊查询 two
	public List<StayRegisterPo> pageFuzzyselectTwos(@Param("receiveTargetID") int receiveTargetID,
												   @Param("isBillID") int isBillID, @Param("codeNumber") String codeNumber,
												   @Param("start") int start, @Param("pageSize") int pageSize);

	//分页模糊查询总条数two
	public int countFuzzyselectTwos(@Param("receiveTargetID") int receiveTargetID,
								   @Param("isBillID") int isBillID, @Param("codeNumber") String codeNumber);

	//分页模糊查询 Three
	public List<StayRegisterPo> pageFuzzyselectThrees(
			@Param("isBillID") int isBillID, @Param("codeNumber") String codeNumber,
			@Param("start") int start, @Param("pageSize") int pageSize);

	//分页模糊查询总条数Three
	public int countFuzzyselectThrees(
			@Param("isBillID") int isBillID, @Param("codeNumber") String codeNumber);

	public int getID(@Param("codeNumber") String codeNumber);

	public String orderIDBystayid(@Param("id") int id);

	public  int codeNumberYZ(@Param("codeNumber") String codeNumber);

	public Integer selectPredetermineById(Integer id);

	public Integer selectStaCount(@Param("supplierid") Integer supplierid);

	public Integer selectStaPlatform(@Param("platformid") Integer platformid);

	public Integer confirmReceipt(@Param("id") int id,@Param("paymentdate")Timestamp paymentdate, @Param("isdao") Integer isdao);
	...
	public List<StayRegisterPo> fuzzyselectAllTwo(@Param("min")Timestamp min,@Param("max") Timestamp max);

	public int countAllTwo(@Param("min")Timestamp min,@Param("max") Timestamp max);

	public List<StayRegisterPo> selectPayTime();

	public  int regiserTime(StayRegisterPo stayRegisterPo);

	public StayRegisterPo selectSP(@Param("id")Integer id);

	//结账 修改原信息
	public int pay2(@Param("id")int id,@Param("payTime") Timestamp payTime,@Param("currency") int currency);
