...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
 ...
 <script type="text/javascript">
    ...
    $.ajax({                                                      
          ...
          data:"roomNumber="+name+"&supplier="+supplier,                         // IDCardValue 自定义的。相当于name把值赋予给 他可以在servlet 获取
//        dataType:"json",                                       // json 数据类型提交 
   ...
   function confirmChangRoom(){     //确定更换房间
     ...
     '&roomId='+roomId+'&changRoomTime='+changRoomTime+'&LvKeLeiXingId='+LvKeLeiXingId
    ...
    function listAllYZ() {
        ...
        if(roomid!="" && checkin!=null){
            $.ajax({
                cache:false,                                             //是否使用缓存提交 如果为TRUE 会调用浏览器的缓存 而不会提交
                type: "POST",                                           //上面3行都是必须要的
                url: '${ctx}/StayRegister/listAllYZ.do',       //地址 type 带参数
                data:"roomid="+roomid.trim()+"&checkin="+checkin.trim(),                         // IDCardValue 自定义的。相当于name把值赋予给 他可以在servlet 获取
                async:false,                                          // 是否 异步 提交
