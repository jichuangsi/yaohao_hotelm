...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container">
    ...
    <div class="span9 margin-top-one">
      <div class="row-fluid">
        <h3 style="text-align: center;">客房修改 Guest room modification</h3>
      </div>
    </div>
    
    <div class="span9 margin-top-two">
      <fieldset>
        <legend>标准房设置(Standard room setting)</legend>
      </fieldset>
    </div>
    
    <form action="${ctx}/RoomSet/update.do" method="post" onsubmit="return verify()">
	   <input type="hidden" name="id" value="${listPo.id}">
		<input type="hidden" name="isBed2" value="${listPo.isBed}">
		<input type="hidden" name="supplierID" value="${listPo.supplierID}">
	    <div class="span12 margin-top-two">
	      <div class="row-fluid">
		      <div class="span5">
			   	  <label class="labelroomnumber marginrighttwo">房间号：<br/><span style="font-size: 14px">Room Number</span></label>
			  ...
			  <div class="span5 ">
			   	  <label class="labelroomnumber marginrightone">房态：<br/><span style="font-size: 14px">Room state</span></label>
	    ...
	    <div class="span12 margin-top-one">
	      <div class="row-fluid">
		      <div class="span5">
				  <label class="labelroomnumber marginrighttwo">床位数：<br/><span style="font-size: 14px">Number of beds</span></label>
			  ...
			  <div class="span5">
			   	  <label class="labelroomnumber">客房等级：<br/><span style="font-size: 14px">Guest room rating</span></label>
	    ...
	    <div class="span12 margin-top-one" >
	      <div class="row-fluid">
		       ...
		       <div class="span6">
			   	  <label class="labelroomnumber">标准房价/天：<br/><span style="font-size: 14px"></span></label>
			  ...
			  <div class="span5">
				  ...
				  <input id="purchasePriceId" name="purchasePrice" class="textone inputtwo radiusone" onblur="onchangeOne()"
						 style="float:left;border-radius:0px; border-top-right-radius:4px; border-bottom-right-radius:4px; height:26px;" type="text" value="${listPo.purchasePrice}">
				  <div id="divT">
					  <label class="yansered" style="margin-top:18px;">*</label>
				  </div>
			  </div>
		...
		<div class="span12 margin-top-one" >
			<div class="row-fluid">
				<div class="span5">
					<label class="labelroomnumber">折扣：<br/><span style="font-size: 14px">Discount</span></label>
					<div class="input-prepend" style="float:left;">
						<span class="add-on" style="margin-top: 12px; height: 16px;">&yen;</span>
					</div>
					<input id="discount" name="discount" class="textone inputtwo radiusone" onblur="onchangeOne()"value="${listPo.discount}"
						   style="float:left;border-radius:0px; border-top-right-radius:4px; border-bottom-right-radius:4px; height:26px;" type="text">

				</div>
				<div class="span4">
					<label class="labelroomnumber">折后价：<br/><span style="font-size: 14px">Discount price</span></label>
					<div class="input-prepend" style="float:left;">
						<span class="add-on" style="margin-top: 12px; height: 16px;">&yen;</span>
					</div>
					<input id="discountPrice" name="discountPrice" class="textone inputtwo radiusone" onblur="onchangePrice()"value="${listPo.discountPrice}"
	   ...
	   <div class="span9 margin-top-one">
	    ...
	    <div class="span12 margin-top-two">
	      <div class="row-fluid">
		      <div class="span5">
			   	  <label class="labelroomnumber" style="margin-right:5px;">标准房价/小时：<br/><span style="font-size: 14px">Standard room rate/hour</span></label>
			      <div class="input-prepend"  style="float:left;">
			        <span class="add-on" style="margin-top: 12px; height: 16px;">&yen;</span>
			      </div>
			  ...
			  <div class="span5">
			   	  <label class="labelroomnumber">时长限制(小时)：<br/><span style="font-size: 14px">Time limit(hours)</span></label>
			      <div class="input-prepend"  style="float:left;">
			        <span class="add-on" style="margin-top: 12px; height: 16px;">&yen;</span>
			      </div>
	    ...
	    <div class="span12 margin-top-one">
	      <div class="row-fluid">
		      <div class="span5">
			   	  <label class="labelroomnumber marginrightthree">首段价格：<br/><span style="font-size: 14px">First price</span></label>
			      <div class="input-prepend"  style="float:left;">
			        <span class="add-on" style="margin-top: 12px; height: 16px;">&yen;</span>
			      </div>
			  ...
			  <div class="span5">
				  <label class="labelroomnumber">首段时长(小时)：<br/><span style="font-size: 14px">First paragraph Duration(hours)</span></label>
			      <div class="input-prepend"  style="float:left;">
			        <span class="add-on" style="margin-top: 12px; height: 16px;">&yen;</span>
			      </div>
		...
		<div class="span9 margin-top-one">
			<fieldset>
				<legend>按床位出租设置<span style="font-size: 14px">Set by bed rental</span></legend>
			</fieldset>
		</div>
		...
		<div class="span12 margin-top-two">
			<div class="row-fluid">
				<div class="span5">
					...
					<input id="bedPrice" name="bedPrice" class="textone inputthree radiusone" onblur="onchangeOne()"value="${listPo.bedPrice}"
						   style="float:left;border-radius:0px; border-top-right-radius:4px; border-bottom-right-radius:4px; height:26px;" type="text">
					<div id="divS1">
						<label class="yansered" style="margin-top:18px;">*</label>
					</div>
				...
				<div class="span5">
					...
					<input id="bedHour" name="bedHour" class="textone inputthree radiusone" onblur="onchangeOne()"value="${listPo.bedHour}"
						   style="float:left;border-radius:0px; border-top-right-radius:4px; border-bottom-right-radius:4px; height:26px;" type="text">
					<div id="divS2">
						<label class="yansered" style="margin-top:18px;">*</label>
					</div>
		...
		<div class="span12 margin-top-one">
			<div class="row-fluid">
				<div class="span5">
					<label class="labelroomnumber marginrightthree">标准房价/天：<br/><span style="font-size: 14px">Standard room rate/day<</span></label>
					<div class="input-prepend"  style="float:left;">
						<span class="add-on" style="margin-top: 12px; height: 16px;">&yen;</span>
					</div>
					<input id="bedDayPrice" name="bedDayPrice" class="textone inputthree radiusone" onblur="onchangeOne()"
						   style="float:left;border-radius:0px; border-top-right-radius:4px; border-bottom-right-radius:4px; height:26px;" type="text"
						   value="${listPo.bedDayPrice}">
					<div id="divS3">
						<label class="yansered" style="margin-top:18px;">*</label>
					</div>
				</div>
				<div class="span5">
					<label class="labelroomnumber">是否可按床位售出：<br/><span style="font-size: 14px">Whether it can be sold by bed</span></label>
					<select name="isBed">
						<c:if test="${listPo.isBed==0}">
						<option value="0"selected>是(yes)</option>
						<option value="1">不是(not)</option>
						</c:if>
						<c:if test="${listPo.isBed==1}">
							<option value="0">是(yes)</option>
							<option value="1"selected>不是(not)</option>
						</c:if>
					</select>
		  ...
		  <div class="span6" style="text-align:center;">
		      <div class="row-fluid">
			      <div class="span12" style="margin-top: 10px;margin-bottom: 8px;">
				   	 ...
				   	 <li class="icon-check icon-white"></li>修改(modify)</button>
				  </div> 
 ...
 <script type="text/javascript">
    ...
    if(document.getElementById("roomNumberId").value==""){
	     ...
	     alert("首段时长  是必填项，不能为空哦！"+' \n '+"The first period of time (hour)is required,cannot be empty!");
