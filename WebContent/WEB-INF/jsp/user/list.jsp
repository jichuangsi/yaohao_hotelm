...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container" >
    <div class="span5">
	    <div class="row-fluid">
		    <label class="labelroomnumber">操作员：<br/>Admin</label>
       ...
       <table class="table table-condensed table-bordered table-striped" id="tableid">
	      <thead class="theadone">
	        <tr>
	          ...
	          <th >姓名<span style="font-size: 12px;">Name</span></th>
               <th >级别<span style="font-size: 12px;">level</span></th>
	        </tr>
	      </thead>
	      <tbody id="tbody">
		        ...
		        <tr>
		          ...
		          <td>${item.userName}</td>
                    <c:if test="${item.grade==1}">
                        <td>超级管理员<span style="font-size: 12px;">Super administrator</span></td>
                    </c:if>
                    <c:if test="${item.grade==2}">
                        <td>普通管理员<span style="font-size: 12px;">General administrator</span></td>
                    </c:if>
		        </tr>
	        </c:forEach>
	      </tbody>
