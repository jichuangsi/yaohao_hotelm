...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container" style="height:630px;overflow-x:auto;">
    ...
    <div class="span9 margin-top-one">
      <div class="row-fluid">
        <h3 style="text-align: center;">操作员新增New operator</h3>
        
      </div>
    </div>
    
    <form action="${ctx}/User/add.do" method="post" onsubmit="return verify()">
    <!--  ———————————————————————————————————————————————————————————————————————————————————————— -->
	    <div class="span12">
	      <div class="row-fluid">
		     <div class="span3">
			  ...
			  <div class="span3">
				  <label>密码：<br/><span style="font-size: 12px">password</span></label>
 ...
 <script type="text/javascript">
    ...
    function verify(){
	    ...
	    if(document.getElementById("userName").value==""){
	     ...
	     document.getElementById("userName").focus();
	     return false;
        }else if(document.getElementById("password").value.length>12 ||document.getElementById("password").value.length<4){
     ...
     if(value!=""){
       $.ajax({                                                      
          ...
          success: function (result) {                          // 不出现异常 进行立面方
	          ...
	          document.getElementById("birthDateId").value=Name;
           }
          },
          error: function(data) {  }
      });
