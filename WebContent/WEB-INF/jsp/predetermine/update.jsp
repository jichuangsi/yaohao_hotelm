...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container" style="height:630px;overflow-x:auto;border: solid; border-color: #DDDDDD;">
    ...
    <div class="span12" style="text-align: center;">
      <div class="row-fluid">
        <h3>客房预订修改(Room reservation modification)</h3>
      </div>
    </div>
    ...
    <div class="span12" >
      <div class="row-fluid">
        <div class="span1">
            <button class="btn btn-info btn-small" type="button" onclick="addfunction()"><li class="icon-plus icon-white"></li>midify</button>
        </div>
        <div class="span1">
           <button class="btn btn-danger btn-small" type="button" onclick="deletefunction()"><li class="icon-remove icon-white"></li>delete</button>
        </div>
         <div class="span1">
            <button class="btn btn-warning btn-small" type="button" onclick="lastStep()"><li class="icon-remove icon-white"></li>cancel</button>
        </div>
         <div class="span2">
            <button href="#xuanzhe" data-toggle="modal" class="btn btn-info btn-small" onclick="selectRoom()"><li class="icon-plus icon-white">
    ...
    <div class="span12" style="margin-top:12px;">
      ...
      <div class="span12" style="margin-top:12px;">
          <div class="row-fluid">
              <div class="span2">
                  <label>订单号：</label>
                  <input name="commodityName" class="widthone" style="height: 26px;"  type="text" readonly="readonly" value="${orderPo.orderID}">
              </div>
              <div class="span2">
                  <label>订单状态：</label>
                  <c:if test="${orderPo.status==0}">
                      <input id="predetermineDayId" name="predetermineDay" class="widthone"
                             style="height: 26px;"  type="text"value="已预订待入住">
                  </c:if>
                  <c:if test="${orderPo.status==1}">
                      <input id="predetermineDayId" name="predetermineDay" class="widthone"
                             style="height: 26px;"  type="text"value="已入住待结账">
                  </c:if>
                  <c:if test="${orderPo.status==2}">
                      <input id="predetermineDayId" name="predetermineDay" class="widthone"
                             style="height: 26px;"  type="text"value="已取消">
                  </c:if>
                  <c:if test="${orderPo.status==3}">
                      <input id="predetermineDayId" name="predetermineDay" class="widthone"
                             style="height: 26px;"  type="text"value="已结账">
                  </c:if>
