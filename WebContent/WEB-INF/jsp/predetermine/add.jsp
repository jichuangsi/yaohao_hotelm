        ...
        <div class="span1">
         ...
         <div class="span2">
            <button href="#xuanzhe" data-toggle="modal" class="btn btn-info btn-small" onclick="selectRoom()">
                <li class="icon-plus icon-white"></li>选择房间(choice room)</button>
        </div>
            ...
            <div class="row-fluid">
                ...
                <div class="span3">
                    <label>是否折扣价：<span style="font-size: 12px;">Discount price or not</span></label>
                        <select name="isdicount" style="height:26px;width:100%;" id="isdicountId">
		   ...
		   <div class="span8">
		      ...
		      <label class="labelroomnumber">房间号：<br/><span style="font-size: 12px;">room number</span></label>
               ...
               <div class="input-append">
			      <button onclick="selectRoom()" class="btn-success textone" style="margin-left:-6px;height:26px;"><li class="icon-search icon-white"></li>search</button>
			   </div>
	       </div>
       ...
       <table class="table table-condensed table-bordered table-striped" id="tableid">
	      <thead class="theadone">
	        <tr>
	          ...
	          <th >床位数<br/><span style="font-size: 12px;">Number of beds</span></th>
	          <th >标准客房/天<br/><span style="font-size: 12px;">Standard room / day</span></th>
                <td>供应商<br/><span style="font-size: 12px;">Supplier</span></td>
   ...
   function confirmfunction(){
     /*  roomIdShuZu.empty(); */
	  ...
	  $('input[name="idTwo"]:checked').each(function(){             // 遍历获取input被checked的
        ...
        tdcheckbox.innerHTML = "<input type='radio' name='idOne' id='roomid' value='"+chk_value[i]+"'>";
