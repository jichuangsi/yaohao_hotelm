...
<div class="container" >
	<div class="span5">
		<div class="row-fluid">
			<label class="labelroomnumber">订单号：</label>
			<form action="${ctx}/Order/tolist.do" method="post" style="float: left;">
				...
				<tr>
					...
					<c:if test="${item.status==3}">
						<td>已结账</td>
                         ...
                         <td>${item.pname}</td>
                         <td hidden="">${item.stayDetailsId}</td>
                         <td hidden="">${item.predeterID}</td>
