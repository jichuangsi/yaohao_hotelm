...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container">
    ...
    <div class="span9 margin-top-one">
      <div class="row-fluid">
        <h3 style="text-align: center;">平台新增New platform</h3>
      </div>
    </div>
    
    <form action="${ctx}/Platform/add.do" method="post" onsubmit="return verify()">
	    <div class="span12">
	      <div class="row-fluid">
		      <div class="span5">
			   	  <label class="labelroomnumber">平台名称：<br/><span style="font-size: 12px;">Platform name</span></label>
			      <input id="commodityNameId" name="name" class="textone inputone"
