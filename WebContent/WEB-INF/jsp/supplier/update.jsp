...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container">
    ...
    <div class="span9 margin-top-one">
      <div class="row-fluid">
        <h3 style="text-align: center;">供应商修改Supplier modification</h3>
      </div>
    </div>
    
    <form action="${ctx}/Supplier/update.do" method="post" onsubmit="return verify()">
	    ...
	    <div class="span12">
	      <div class="row-fluid">
		      <div class="span5">
			      ...
			      <input id="commodityNameId" name="supplierName" class="textone inputone" value="${listPo.supplierName}"
 ...
 <script type="text/javascript">
    ...
    function deletefunction(){
     parent.document.getElementById('Mainid').src='${ctx}/Supplier/tolist.do';
   }
       ...
       $.ajax({                                                      
          ...
          success: function (result) {                          // 不出现异常 进行立面方
              if(Name==document.getElementById("commodityNameId").value){
                   ...
                   alert("已存在此供应商名称，请另取平供应商名称！"+' \n '+"This vendor name already exists");                     //提示框
