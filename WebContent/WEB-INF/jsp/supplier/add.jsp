...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container">
    ...
    <div class="span9 margin-top-one">
      <div class="row-fluid">
        <h3 style="text-align: center;">供应商新增New supplier</h3>
      </div>
    </div>
    
    <form action="${ctx}/Supplier/add.do" method="post" onsubmit="return verify()">
	    <div class="span12">
	      <div class="row-fluid">
		      <div class="span5">
			   	  <label class="labelroomnumber">供应商名称：<br/><span style="font-size: 12px;">Supplier name</span></label>
			      <input id="commodityNameId" name="supplierName" class="textone inputone"
